...
## Environments
- Preview: https://main--terrischeer--pranay-tippa.hlx.page/
- Live: https://main--terrischeer--pranay-tippa.hlx.live/
...
1. Open the `terrischeer` directory in your favorite IDE and start coding :)
